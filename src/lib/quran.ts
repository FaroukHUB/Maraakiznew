/**
 * Table des sourates : numéro, nom translittéré, nombre de versets.
 *
 * Sert à proposer une liste plutôt qu'une saisie libre, et à valider qu'une
 * plage de versets existe bien dans la sourate choisie.
 *
 * À relire avant mise en production : les translittérations varient d'un
 * usage à l'autre, et l'institut a peut-être ses propres conventions.
 */
...
export const SURAHS: Surah[] = [
  ...
  { number: 45, name: "Al-Jathiya", ayahCount: 37 },
  ...
  { number: 69, name: "Al-Haqqa", ayahCount: 52 },
  ...
  { number: 75, name: "Al-Qiyama", ayahCount: 40 },
  ...
  { number: 88, name: "Al-Ghashiya", ayahCount: 26 },
  ...
  { number: 98, name: "Al-Bayyina", ayahCount: 8 },
  { number: 99, name: "Az-Zalzala", ayahCount: 8 },
  { number: 100, name: "Al-Adiyat", ayahCount: 11 },
  { number: 101, name: "Al-Qari'a", ayahCount: 11 },
  { number: 102, name: "At-Takathur", ayahCount: 8 },
  { number: 103, name: "Al-Asr", ayahCount: 3 },
  { number: 104, name: "Al-Humaza", ayahCount: 9 },
...
export function formatPortion(
  ...
  const name = surah ? surah.name : `Sourate ${surahNumber}`;
  return ayahStart === ayahEnd
    ? `${name}, verset ${ayahStart}`
    : `${name}, versets ${ayahStart} à ${ayahEnd}`;
}
