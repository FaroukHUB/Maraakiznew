...
import { CountryTimezoneFields, type AddressValues } from "@/components/ui/country-timezone-fields";

export function NewStudentForm({ instituteZoneLabel }: { instituteZoneLabel: string }) {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Adresse et fuseau horaire</CardTitle>
          </CardHeader>
          <CardContent>
